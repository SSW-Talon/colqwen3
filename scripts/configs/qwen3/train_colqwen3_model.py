...
def parse_args():
    ...
    p.add_argument("--output-dir", type=str, default="/mnt/data1/ygm/colqwen3-v1", help="where to write model + script copy")
    p.add_argument("--lr", type=float, default=5e-5, help="learning rate")
    p.add_argument("--tau", type=float, default=0.05, help="temperature for loss function")
...
if __name__ == "__main__":
    ...
    config = ColModelTrainingConfig(
        ...
        processor=ColQwen3Processor.from_pretrained(
            pretrained_model_name_or_path="/mnt/data1/ygm/colqwen3-base",
        ...
        tr_args=TrainingArguments(
            ...
            save_total_limit=1,
            ddp_find_unused_parameters=True, # 新增
        ),
